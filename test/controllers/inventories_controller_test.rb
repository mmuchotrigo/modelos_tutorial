...
class InventoriesControllerTest < ActionController::TestCase
  ...
  test "should create inventory" do
    assert_difference('Inventory.count') do
      post :create, inventory: { product_id: @inventory.product_id, stock: @inventory.stock, warehouse_id: @inventory.warehouse_id }
    end
  ...
  test "should update inventory" do
    patch :update, id: @inventory, inventory: { product_id: @inventory.product_id, stock: @inventory.stock, warehouse_id: @inventory.warehouse_id }
    assert_redirected_to inventory_path(assigns(:inventory))
  end
